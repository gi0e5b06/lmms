...
PeakControllerEffectControls::PeakControllerEffectControls(
        PeakControllerEffect* _eff) :
      EffectControls(_eff),
      m_effect(_eff),
...
void PeakControllerEffectControls::loadSettings(const QDomElement& _this)
{
    ...
    if(_this.hasAttribute("abs"))
        m_modeModel.loadSettings(_this, "abs");
    if(_this.hasAttribute("mode"))
                                                ...
                                                QDomElement&  _this)
{
    ...
    m_modeModel.saveSettings(_doc, _this, "abs");  // COMPAT
