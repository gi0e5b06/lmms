...
class WatsynObject
{
  ...
  private:
    ...
    real_t m_lphase[NUM_OSCS];
    real_t m_rphase[NUM_OSCS];
...
class WatsynInstrument : public Instrument
{
  ...
  protected:
    real_t m_lvol[NUM_OSCS];
    real_t m_rvol[NUM_OSCS];

    real_t m_lfreq[NUM_OSCS];
    real_t m_rfreq[NUM_OSCS];
