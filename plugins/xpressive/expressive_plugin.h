...
class Expressive : public Instrument
{
  ...
  public:
    ...
    {
        return m_wavesExpression[i];
    }
    QByteArray& outputExpression(int i)
    {
        return m_outputExpression[i];
    }

    FloatModel& parameterA1()
    {
        return m_parameterA1;
    }
    FloatModel& parameterA2()
    {
        return m_parameterA2;
    }
    FloatModel& parameterA3()
    {
        return m_parameterA3;
    }
    FloatModel& smoothW1()
    {
        return m_smoothW1;
    ...
    {
        return m_interpolateW1;
    }
    BoolModel& interpolateW2()
    {
        return m_interpolateW2;
    }
    BoolModel& interpolateW3()
    {
        return m_interpolateW3;
    }
    FloatModel& panning1()
    {
        return m_panning1;
    ...
    static void
            smooth(float smoothness, const GraphModel* in, GraphModel* out);
...
class expressiveView : public InstrumentView
{
    Q_OBJECT
  public:
    expressiveView(Instrument* _instrument, QWidget* _parent);
