...
class expressiveKnob : public Knob
{
  public:
    ...
    expressiveKnob(QWidget* _parent) : Knob(knobStyled, _parent)
    {
        setStyle();
    }
};
...

{
    ...
    m_smoothKnob->setModel(
            new FloatModel(0.f, 0.f, 1.f, 0.001f, NULL, "smooth", true),
            m_smoothKnob),
...
void Expressive::smooth(float             smoothness,
                        const GraphModel* in,
                        GraphModel*       out)
{
...
QString expressiveHelpView::s_helpText
        = "<b>O1, O2</b> - Two output waves. Panning is controled by PN1 and "
          ...
          "<b>last(n)</b> - Gives you the last n'th evaluated sample. The "
          "argument n must be in the range [1,500], or else, it will return "
          "0.<br>"
