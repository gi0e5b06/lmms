      ...
      ToolPluginView(_tool)
{
    ...
    m_tabBar->addTab(instruments, tr("Instruments"), 2, false, true)
    ...
    setWhatsThis(
            tr("This dialog displays information on all of the LADSPA "
               "plugins LMMS was "
               "able to locate. The plugins are divided into five categories "
               "based "
               "upon an interpretation of the port types and names.\n\n"

               "Available Effects are those that can be used by LMMS. In "
               "order for LMMS "
               "to be able to use an effect, it must, first and foremost, be "
               "an effect, "
               "which is to say, it has to have both input channels and "
               "output channels. "
               "LMMS identifies an input channel as an audio rate port "
               "containing 'in' in "
               "the name. Output channels are identified by the letters "
               "'out'. Furthermore, "
               "the effect must have the same number of inputs and outputs "
               "and be real time "
               "capable.\n\n"

               "Unavailable Effects are those that were identified as "
               "effects, but either "
               "didn't have the same number of input and output channels or "
               "weren't real "
               "time capable.\n\n"

               "Instruments are plugins for which only output channels were "
               "identified.\n\n"

               "Analysis Tools are plugins for which only input channels "
               "were identified.\n\n"

               "Don't Knows are plugins for which no input or output "
               "channels were "
               "identified.\n\n"

               "Double clicking any of the plugins will bring up information "
               "on the "
               "ports."));
...
QWidget* ladspaBrowserView::createTab(QWidget*         _parent,
                                      const QString&   _txt,
