      ...
      EffectControlDialog(_controls)
{
    ...
    PixmapButton* addOneButton
            = new PixmapButton(this, tr("Increase graph amplitude by 1dB"));
    ...
    PixmapButton* subOneButton
            = new PixmapButton(this, tr("Decrease graph amplitude by 1dB"));
    ...
    LedCheckBox* clipInputToggle = new LedCheckBox(
            "Clip input", this, tr("Clip input"), LedCheckBox::Green);
