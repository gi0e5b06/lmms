/*
 * carlaeffectrack.cpp - Carla for LMMS (Effectrack)
 *
...
{
    qInfo("carlaeffectrack::lmms_plugin_main");
    return new CarlaEffect(_parent, &carlaeffectrack_plugin_descriptor, false);
}
