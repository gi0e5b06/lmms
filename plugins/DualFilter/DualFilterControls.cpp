...
DualFilterControls::DualFilterControls(DualFilterEffect* effect) :
      ...
      m_cut1Model(
              7000.0f, 1.0f, 20000.0f, 1.0f, this, tr("Cutoff 1 frequency")),
      m_res1Model(0.5,
                  BasicFilters<0>::minQ(),
                  10.0,
                  0.01,
      ...
      m_cut2Model(
              7000.0f, 1.0f, 20000.0f, 1.0f, this, tr("Cutoff 2 frequency")),
      m_res2Model(0.5,
                  BasicFilters<0>::minQ(),
                  10.0,
                  0.01,
      ...
      m_gain2Model(100.0f, 0.0f, 200.0f, 0.1f, this, tr("Gain 2"))
{
    ...
    m_filter1Model.addItem(tr("BandPass czpg"),
    ...
    m_filter1Model.addItem(tr("RC12 LowPass"), new PixmapLoader("filter_lp"));
    m_filter1Model.addItem(tr("RC12 BandPass"),
                           new PixmapLoader("filter_bp"));
    m_filter1Model.addItem(tr("RC12 HighPass"),
                           new PixmapLoader("filter_hp"));
    m_filter1Model.addItem(tr("RC24 LowPass"), new PixmapLoader("filter_lp"));
    m_filter1Model.addItem(tr("RC24 BandPass"),
                           new PixmapLoader("filter_bp"));
    m_filter1Model.addItem(tr("RC24 HighPass"),
                           new PixmapLoader("filter_hp"));
    m_filter1Model.addItem(tr("Vocal Formant"),
                           new PixmapLoader("filter_hp"));
    ...
    m_filter1Model.addItem(tr("Peak"), new PixmapLoader("filter_bp"));
    ...
    m_filter2Model.addItem(tr("BandPass czpg"),
                           new PixmapLoader("filter_bp"));
    ...
    m_filter2Model.addItem(tr("RC12 LowPass"), new PixmapLoader("filter_lp"));
    m_filter2Model.addItem(tr("RC12 BandPass"),
                           new PixmapLoader("filter_bp"));
    m_filter2Model.addItem(tr("RC12 HighPass"),
                           new PixmapLoader("filter_hp"));
    m_filter2Model.addItem(tr("RC24 LowPass"), new PixmapLoader("filter_lp"));
    m_filter2Model.addItem(tr("RC24 BandPass"),
                           new PixmapLoader("filter_bp"));
    m_filter2Model.addItem(tr("RC24 HighPass"),
                           new PixmapLoader("filter_hp"));
    m_filter2Model.addItem(tr("Vocal Formant Filter"),
                           new PixmapLoader("filter_hp"));
    ...
    m_filter2Model.addItem(tr("Peak"), new PixmapLoader("filter_bp"));
...
void DualFilterControls::updateFilters()
{
    ...
    m_effect->m_filter1
            = new BasicFilters<2>(Engine::mixer()->processingSampleRate());
    m_effect->m_filter2
            = new BasicFilters<2>(Engine::mixer()->processingSampleRate());
