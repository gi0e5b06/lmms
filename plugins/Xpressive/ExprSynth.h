...
class ExprFront
{
  public:
    ...
    bool           add_cyclic_vector(const char*  name,
                                     const float* data,
                                     size_t       length,
                                     bool         interp = false);
    void           setIntegrate(const unsigned int* frameCounter,
...
class WaveSample
{
  public:
    ...
    inline void setInterpolate(bool _interpolate)
    {
...
class ExprSynth
{
    MM_OPERATORS
  public:
    ExprSynth(const WaveSample*   gW1,
