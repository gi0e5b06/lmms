...
EqControls::EqControls(EqEffect* effect) :
      ...
      m_para1BwModel(0.3, 0.001, 4, 0.001, this, tr("Peak 1 BW")),
      m_para2BwModel(0.3, 0.001, 4, 0.001, this, tr("Peak 2 BW")),
      m_para3BwModel(0.3, 0.001, 4, 0.001, this, tr("Peak 3 BW")),
      m_para4BwModel(0.3, 0.001, 4, 0.001, this, tr("Peak 4 BW")),
      ...
      m_lowShelfFreqModel(
              80.0, 20.0, 20000, 0.001, this, tr("Low Shelf freq")),
      ...
      m_highShelfFreqModel(
              12000.0, 20.0, 20000, 0.001, this, tr("High shelf freq")),
...
{
    m_passesModel.addItem("once");
    m_passesModel.addItem("twice");
    m_passesModel.addItem("thrice");
