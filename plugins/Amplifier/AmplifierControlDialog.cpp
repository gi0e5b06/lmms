      ...
      EffectControlDialog(controls)
{
    ...
    VolumeKnob* volumeKnob = new VolumeKnob(knobBright_26, this);
    ...
    VolumeKnob* leftKnob = new VolumeKnob(knobBright_26, this);
    leftKnob->move(16, 65);
    ...
    VolumeKnob* rightKnob = new VolumeKnob(knobBright_26, this);
