...
ShifterGDXControls::ShifterGDXControls(ShifterGDX* effect) :
      ...
      m_deltaFrequencyModel(
              0., -20000., 20000., 1., this, tr("Delta frequency")),
      m_lowFrequencyModel(
              0., 0., 20000., 1., this, tr("Low frequency")),
      m_highFrequencyModel(
              20000., 0., 20000., 1., this, tr("High frequency")),
      m_factorFrequencyModel(
              0.220, 0., 1., 0.001, this, tr("Factor")),
      m_deltaVolumeModel(0., -1., 1., 0.0001, this, tr("Delta volume")),
      m_lowVolumeModel(
...
{
    m_deltaFrequencyModel.loadSettings(_this, "delta_frequency");
    m_deltaVolumeModel.loadSettings(_this, "delta_volume");
}

void ShifterGDXControls::saveSettings(QDomDocument& _doc, QDomElement& _this)
{
    m_deltaFrequencyModel.saveSettings(_doc, _this, "delta_frequency");
    m_deltaVolumeModel.loadSettings(_this, "delta_volume");
}
