...
constexpr int COMP_SCREEN_X        = 1000;
constexpr int COMP_SCREEN_Y        = 700;
...
constexpr real_t COMP_NOISE_FLOOR = 0.000001;  // -120 dbFs
...
class CompressorControlDialog : public EffectControlDialog
{
  ...
  public:
    ...
    {
        return QSize(COMP_SCREEN_X, COMP_SCREEN_Y);
    }

    // For theming purposes
    Q_PROPERTY(
            QColor inVolAreaColor READ inVolAreaColor WRITE setInVolAreaColor)
    Q_PROPERTY(QColor inVolColor READ inVolColor WRITE setInVolColor)
    Q_PROPERTY(QColor outVolAreaColor READ outVolAreaColor WRITE
                       setOutVolAreaColor)
    Q_PROPERTY(QColor outVolColor READ outVolColor WRITE setOutVolColor)
    Q_PROPERTY(QColor gainReductionColor READ gainReductionColor WRITE
                       setGainReductionColor)
  ...
  private:
    ...
    inline int dbfsToYPoint(real_t inDbfs);
    inline int dbfsToXPoint(real_t inDbfs);
