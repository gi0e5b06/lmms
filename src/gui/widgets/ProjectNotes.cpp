...
ProjectNotes::ProjectNotes() : QMainWindow(gui->mainWindow()->workspace())
{
    qInfo("ProjectNotes::ProjectNotes 1");
    ...
    setWindowIcon(embed::getIcon("project_notes"));
...
void ProjectNotes::setupActions()
{
    ...
    a = new QAction(embed::getIcon("edit_undo"), tr("&Undo"), this);
    a->setShortcut(QKeySequence::Undo);
    connect(a, SIGNAL(triggered()), m_edit, SLOT(undo()));
    tb->addAction(a);

    a = new QAction(embed::getIcon("edit_redo"), tr("&Redo"), this);
    ...
    {
        new QShortcut(QKeySequence(Qt::CTRL + Qt::Key_Y), m_edit,
                      SLOT(redo()));
    }
    if(QKeySequence(QKeySequence::Redo)
       != QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_Z))
    {
        new QShortcut(QKeySequence(Qt::CTRL + Qt::SHIFT + Qt::Key_Z), m_edit,
                      SLOT(redo()));
    }

    a = new QAction(embed::getIcon("edit_copy"), tr("&Copy"), this);
    a->setShortcut(QKeySequence::Copy);
    connect(a, SIGNAL(triggered()), m_edit, SLOT(copy()));
    tb->addAction(a);

    a = new QAction(embed::getIcon("edit_cut"), tr("Cu&t"), this);
    a->setShortcut(QKeySequence::Cut);
    connect(a, SIGNAL(triggered()), m_edit, SLOT(cut()));
    tb->addAction(a);

    a = new QAction(embed::getIcon("edit_paste"), tr("&Paste"), this);
    ...
    m_comboSize->lineEdit()->setText(
            QString::number(QApplication::font().pointSize()));

    m_actionTextBold
            = new QAction(embed::getIcon("text_bold"), tr("&Bold"), this);
    ...
    m_actionTextItalic
            = new QAction(embed::getIcon("text_italic"), tr("&Italic"), this);
    ...
    m_actionTextUnderline = new QAction(embed::getIcon("text_under"),
                                        tr("&Underline"), this);
    ...
    m_actionAlignLeft
            = new QAction(embed::getIcon("text_left"), tr("&Left"), m_edit);
    ...
    m_actionAlignCenter = new QAction(embed::getIcon("text_center"),
                                      tr("C&enter"), m_edit);
    ...
    m_actionAlignRight
            = new QAction(embed::getIcon("text_right"), tr("&Right"), m_edit);
    ...
    m_actionAlignJustify = new QAction(embed::getIcon("text_block"),
                                       tr("&Justify"), m_edit);
