/*
 * MidiEffectView.cpp - view-component for an effect
 *
	...
	m_controlView( NULL )
{
	...
	// Disable effects that are of type "DummyMidiEffect"
	bool isEnabled = !dynamic_cast<DummyMidiEffect *>( effect() );
...
void MidiEffectView::editControls()
{
...
void MidiEffectView::deletePlugin()
{
...
void MidiEffectView::displayHelp()
{
...
void MidiEffectView::closeEffects()
{
	if( m_subWindow )
	{
		m_subWindow->hide();
...
void MidiEffectView::contextMenuEvent( QContextMenuEvent * )
{
...
void MidiEffectView::paintEvent( QPaintEvent * )
{
	QPainter p( this );
...
void MidiEffectView::modelChanged()
{
