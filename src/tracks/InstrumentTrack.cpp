	...
	m_instrumentView( NULL )
{
	...
	Qt::Alignment widgetAlignment = Qt::AlignHCenter | Qt::AlignBottom;//Center;
	...
	m_pitchRangeSpinBox= new LcdSpinBox( 2, "19cyan", NULL, tr( "Pitch range (semitones)" ) );
        m_pitchRangeSpinBox->setText(tr("RANGE"));
